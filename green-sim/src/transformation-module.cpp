...
glm::mat4 TransformationModule::GetFinalTransformMat() {
	...
	glm::mat4x4 scaling_matrix = glm::scale(glm::mat4(1.0), scale);

	glm::mat4x4 x_rotation_matrix = glm::rotate(glm::mat4(1.0), rotation.x, X_AXIS);

	glm::mat4x4 y_rotation_matrix = glm::rotate(glm::mat4(1.0), rotation.y, Y_AXIS);
	
	glm::mat4x4 z_rotation_matrix = glm::rotate(glm::mat4(1.0), rotation.z, Z_AXIS);

	glm::mat4x4 translation_matrix = glm::translate(glm::mat4(1.0), coordinate);
